...
const Business = () => {
    return ( 
        <div className="h-[580px] sm:h-[540px] lsm:h-[500px] md:h-[540px] lg:h-96 w-full grid ">
            <div className="place-self-center h-4/5 w-10/12 lg:flex lg:justify-around lg:items-center space-y-8 lg:space-y-0">
                <div className="lg:w-[40%] space-y-2 md:space-y-4">
                ...
                <div className="lg:w-[40%] space-y-2 md:space-y-4">
                    {businesses.map((business=>(
                        <div className="flex items-center space-x-5 p-2 bgGradient__gray hover:shadow-inner z-[20] cursor-pointer rounded-2xl" key={business.id}>
